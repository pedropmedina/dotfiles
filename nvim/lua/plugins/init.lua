...
return require("packer").startup(
        ...
        -- Themes
        use { "joshdick/onedark.vim", config = [[require("plugins/config/onedark")]] }
        ...
        -- Snippets
        use { "hrsh7th/vim-vsnip", config = [[require("plugins/config/snippets")]] }
        ...
        -- Treesitter support
        use { "theHamsta/nvim-treesitter", branch = "lockfile", config = [[require("plugins/config/treesitter")]] }
        ...
        -- Status line
        use { "glepnir/galaxyline.nvim", branch = "main", config = [[require("plugins/config/statusline")]] }
        ...
        use { "junegunn/rainbow_parentheses.vim", config = [[require("plugins/config/rainbow")]] }
