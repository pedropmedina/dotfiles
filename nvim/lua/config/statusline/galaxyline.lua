...
section.left[7] = {
    DiagnosticHint = { provider = "DiagnosticHint", icon = "• ", highlight = { COLORS.white, COLORS.bg } }
}
...
section.left[9] = {
    DiagnosticError = { provider = "DiagnosticError", icon = "• ", highlight = { COLORS.darkred, COLORS.bg } }
}
...
section.left[11] = {
    DiagnosticWarn = { provider = "DiagnosticWarn", icon = "• ", highlight = { COLORS.darkyellow, COLORS.bg } }
}
...
section.right[2] = {
    DiffAdd = { provider = "DiffAdd", condition = checkwidth, icon = "+", highlight = { COLORS.green, COLORS.darkgrey } }
}
